...
namespace log4net
{
    internal static class CompatibilityExtensions
    {
        ...
        public static Attribute[] GetCustomAttributes(this Type type, Type other, bool inherit) => (Attribute[]) type.GetTypeInfo().GetCustomAttributes(other, inherit).ToArray();
